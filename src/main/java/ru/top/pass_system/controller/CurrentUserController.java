...
public class CurrentUserController {
    ...
    @PatchMapping
    public ResponseEntity<String> changePassword(@RequestBody ChangePasswordForCurrentUserDTO changePasswordForCurrentUserDTO) {
        currentUserService.changePassword(changePasswordForCurrentUserDTO);
